...
#define RCC_HSICALIBRATION_8MHz         ((0x0<<RCC_ICSCR_HSI_FS_CR_Pos) | ((*(vu32 *)(0x1FFF0100)) & 0xFFFF))  /*!< 8MHz HSI calibration trimming value  */
#define RCC_HSICALIBRATION_16MHz        ((0x1<<RCC_ICSCR_HSI_FS_CR_Pos) | ((*(vu32 *)(0x1FFF0104)) & 0xFFFF))  /*!< 16MHz HSI calibration trimming value  */
#define RCC_HSICALIBRATION_24MHz        ((0x2<<RCC_ICSCR_HSI_FS_CR_Pos) | ((*(vu32 *)(0x1FFF0108)) & 0xFFFF))  /*!< 24MHz HSI calibration trimming value */
#define RCC_HSICALIBRATION_48MHz        ((0x3<<RCC_ICSCR_HSI_FS_CR_Pos) | ((*(vu32 *)(0x1FFF010C)) & 0xFFFF))  /*!< 48MHz HSI calibration trimming value */
...
void InitRccAndFlashParam(void)
{
  ...
  MODIFY_REG(RCC->ICSCR, (RCC_ICSCR_HSI_FS_CR | RCC_ICSCR_HSI_ABS_TRIMCR | RCC_ICSCR_HSI_TC_TRIMCR), RCC_HSICALIBRATION_24MHz);
...
void UnInitRccAndFlashParam(void)
{
  ...
  {
  case RCC_ICSCR_HSI_FS_CR:/* 48MHz */
    FLASH->ACR |= FLASH_ACR_LATENCY;   /* Wait State */
    MODIFY_REG(RCC->ICSCR, (RCC_ICSCR_HSI_FS_CR | RCC_ICSCR_HSI_ABS_TRIMCR | RCC_ICSCR_HSI_TC_TRIMCR),
               RCC_HSICALIBRATION_48MHz);                 /*!< 48MHz HSI calibration trimming value */
    break;
  case RCC_ICSCR_HSI_FS_CR_1:/* 24MHz */
    MODIFY_REG(RCC->ICSCR, (RCC_ICSCR_HSI_FS_CR | RCC_ICSCR_HSI_ABS_TRIMCR | RCC_ICSCR_HSI_TC_TRIMCR),
               RCC_HSICALIBRATION_24MHz);                 /* Set HSI 24M and Triming Data */
    break;
  case RCC_ICSCR_HSI_FS_CR_0:/* 16MHz */
    MODIFY_REG(RCC->ICSCR, (RCC_ICSCR_HSI_FS_CR | RCC_ICSCR_HSI_ABS_TRIMCR | RCC_ICSCR_HSI_TC_TRIMCR),
               RCC_HSICALIBRATION_16MHz);                 /* Set HSI 16M and Triming Data */
    break;
  default:/* 8MHz */
    MODIFY_REG(RCC->ICSCR, (RCC_ICSCR_HSI_FS_CR | RCC_ICSCR_HSI_ABS_TRIMCR | RCC_ICSCR_HSI_TC_TRIMCR),
               RCC_HSICALIBRATION_8MHz);                 /* Set HSI 8M and Triming Data */
    break;
  }
  while (RCC_CR_HSIRDY != READ_BIT(RCC->CR, RCC_CR_HSIRDY));
}
