...
typedef struct
{
    ...
    vu32 CFGR;        /*!< RCC Regulated Domain Clocks Configuration Register,                     Address offset: 0x08 */
    vu32 RESERVED0;   /*!< Reserved,                                                               Address offset: 0x0C */
    vu32 ECSCR;       /*!< RCC External clock source control register,                             Address offset: 0x10 */
    vu32 RESERVED1;   /*!< Reserved,                                                               Address offset: 0x14 */
    vu32 CIER;        /*!< RCC Clock Interrupt Enable Register,                                    Address offset: 0x18 */
    vu32 CIFR;        /*!< RCC Clock Interrupt Flag Register,                                      Address offset: 0x1C */
    vu32 CICR;        /*!< RCC Clock Interrupt Clear Register,                                     Address offset: 0x20 */
    vu32 IOPRSTR;     /*!< RCC IO port reset register,                                             Address offset: 0x24 */
    vu32 AHBRSTR;     /*!< RCC AHB peripherals reset register,                                     Address offset: 0x28 */
    vu32 APBRSTR1;    /*!< RCC APB peripherals reset register 1,                                   Address offset: 0x2C */
    vu32 APBRSTR2;    /*!< RCC APB peripherals reset register 2,                                   Address offset: 0x30 */
    vu32 IOPENR;      /*!< RCC IO port enable register,                                            Address offset: 0x34 */
    vu32 AHBENR;      /*!< RCC AHB peripherals clock enable register,                              Address offset: 0x38 */
    vu32 APBENR1;     /*!< RCC APB peripherals clock enable register1,                             Address offset: 0x3C */
    vu32 APBENR2;     /*!< RCC APB peripherals clock enable register2,                             Address offset: 0x40 */
    vu32 RESERVED2[4];/*!< Reserved,                                                               Address offset: 0x44-0x50 */
    vu32 CCIPR;       /*!< RCC Peripherals Independent Clocks Configuration Register,              Address offset: 0x54 */
    vu32 RESERVED3;   /*!< Reserved,                                                               Address offset: 0x58 */
    vu32 BDCR;        /*!< RCC Backup Domain Control Register,                                     Address offset: 0x5C */
    vu32 CSR;         /*!< RCC Unregulated Domain Clock Control and Status Register,               Address offset: 0x60 */
} RCC_TypeDef;
...
u32 RCC_ICSCR_RESTORE;
u32 FLASH_ACR_RESTORE;
